...
export function isScrollable(element: HTMLElement): boolean {
  ...
  const isScrollableOverflow = overflowY === 'scroll' || overflowY === 'auto';
  return hasScrollableContent && isScrollableOverflow;
}

/**
 * Utility function to get the nearest scrollable parent
 */
 ...
 */
export function scrollToTop(scrollContainer?: HTMLElement | Window): void {
 ...
 */
export function scrollToBottom(scrollContainer?: HTMLElement | Window): void {
  const container = scrollContainer ?? window;
  if (container === window) {
